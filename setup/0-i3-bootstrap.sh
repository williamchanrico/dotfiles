...
declare -A packages=(
	...
	["satty"]="Satty - Screenshot editing tool"
	...
	["tree-sitter-cli"]="tree-sitter-cli - CLI tool for developing, testing, and using Tree-sitter parsers"
	...
	["lua-jsregexp"]="lua-jsregexp - JavaScript regular expressions for Lua 5.4"
	["ansible-language-server"]="Ansible Language Server - Ansible Language Server"
